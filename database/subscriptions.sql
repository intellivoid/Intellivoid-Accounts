...
(
    ...
    subscription_name  varchar(255) null comment 'User-friendly name of this subscription',
    application_id     int(255)     null comment 'The ID of the Application that this subscription is associated with',
